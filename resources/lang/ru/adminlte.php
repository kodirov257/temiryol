...
return [
    ...
    'operation' => [
        ...
        'fixing' => 'Ремонтировние',
        'deadline' => 'Крайний срок',
        'deadline_date' => 'Дата Крайнего срока',
        'deadline_time' => 'Время Крайнего срока',
        'instrument_status' => 'Состояние Инструмента',
        'related' => 'Связанные Операции',
        'is_closed' => 'Операция уже закрыта.',
        'is_prolonged' => 'Операция продлена.',
    ],
];
