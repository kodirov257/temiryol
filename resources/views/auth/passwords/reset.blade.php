<x-auth-page-layout auth_type="login">
    @php( $password_reset_url = View::getSection('password_reset_url') ?? config('adminlte.password_reset_url', 'password.email.reset') )
    ...
    @section('auth_header', __('adminlte.password_reset_message'))
